class LWCE_UIChooseTech extends UIChooseTech;

simulated function XGResearchUI GetMgr()
{
    if (m_kLocalMgr == none)
    {
        m_kLocalMgr = XGResearchUI(XComHQPresentationLayer(controllerRef.m_Pres).GetMgr(class'LWCE_XGResearchUI', (self), m_iView));
    }
...
protected simulated function LWCE_UpdateInfoPanelData(int iTechIndex)
{
