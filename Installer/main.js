...
const bytestrings = [
    ...
    // Changes the iteration/recursion limit from 1 million to 0x0FFFFFFF
    {
        "original":    Buffer.from([ 0x3D, 0x40, 0x42, 0x0F, 0x00, 0x0F, 0x8E, 0xB1 ]),
        "replacement": Buffer.from([ 0x3D, 0xFF, 0xFF, 0xFF, 0x0F, 0x0F, 0x8E, 0xB1 ])
    },

    // Deliberate copy of the above change (one for iteration, one for recursion)
    {
        "original":    Buffer.from([ 0x3D, 0x40, 0x42, 0x0F, 0x00, 0x0F, 0x8E, 0xB1 ]),
        "replacement": Buffer.from([ 0x3D, 0xFF, 0xFF, 0xFF, 0x0F, 0x0F, 0x8E, 0xB1 ])
    }
