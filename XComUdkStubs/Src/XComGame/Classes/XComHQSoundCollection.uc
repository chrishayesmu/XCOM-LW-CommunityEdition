...
{
    MusicCueNames(0)=""
    MusicCueNames(1)="HQSound_MCMusic.MissionControlSoundtrackCue"
    MusicCueNames(2)=""
    MusicCueNames(3)="HQSound_Act1Music.HQSoundtrackAct1Cue"
    MusicCueNames(4)="HQSound_Act2Music.HQSoundtrackAct2Cue"
    MusicCueNames(5)="HQSound_Act3Music.HQSoundtrackAct3Cue"
    MusicCueNames(6)="HQSound_MemorialMusic.Memorial_Cue"
    MusicCueNames(7)="HQSound_InterceptionMusic.InterceptionMusicCue"
    MusicCueNames(8)="HQSound_SoldierSelect.ReadyForBattleMusicCue"
    MusicCueNames(9)="Sound_CreditsMusic.CreditMusicWinCue"
    MusicCueNames(10)="HQSound_YouLoseMusic.YouLoseMusicCue"
    AmbientCueNames(0)=""
    AmbientCueNames(1)=""
    AmbientCueNames(2)="HQAmbient_Generic.GenericBaseLoopCue"
    AmbientCueNames(3)="HQAmbient_ScienceLab.ScienceLabLoopCue"
    AmbientCueNames(4)="HQAmbient_Barracks.BarracksLoopCue"
    AmbientCueNames(5)="HQAmbient_Hangar.HangarLoopCue"
    AmbientCueNames(6)="HQAmbient_Engineering.EngineeringLoopCue"
    AmbientCueNames(7)="HQAmbient_SitRoom.SituationRoomLoopCue"
    AmbientCueNames(8)="HQAmbient_Foundry.FoundryLoopCue"
    AmbientCueNames(9)="HQAmbient_Gollop.GollopChamberLoopCue"
    AmbientCueNames(10)="HQAmbient_GeneLab.GeneticsLabLoopCue"
}