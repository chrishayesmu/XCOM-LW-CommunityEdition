...
var native private	transient noimport pointer	SceneInfo;

var native transient matrix			WorldToLight;
var native transient matrix			LightToWorld;
 ...
 */
var	duplicatetransient guid	LightGuid;
/**
 * GUID used to associate a light component with precomputed shadowing information across levels.
 * The GUID changes whenever any of the lighting relevant properties changes.
 */
var duplicatetransient guid	LightmapGuid;

var() interp float Brightness <UIMin=0.0 | UIMax=20.0>;
 ...
 */
var() editinline export LightFunction Function;
 ...
 *
 **/
var() ELightAffectsClassification LightAffectsClassification;
 ...
 */
var native duplicatetransient int LightListIndex;
...
defaultproperties
{
    ...
    ShadowFilterRadiusModifier=1.0
