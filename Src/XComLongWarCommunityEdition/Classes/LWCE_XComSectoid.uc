class LWCE_XComSectoid extends XComSectoid;
...
{
    `LWCE_LOG_CLS("PostInitAnimTree");

    `LWCE_LOG_CLS("SkelComp == Mesh: " $ (SkelComp == Mesh));
    `LWCE_LOG_CLS("Mesh.Animations != none: " $ (Mesh.Animations != none));
...
{
    `LWCE_LOG_CLS("RestoreAnimSetsToDefault: DefaultUnitPawnAnimsets.Length = " $ DefaultUnitPawnAnimsets.Length);
