class LWCE_Checkpoint_StrategyTransport extends Checkpoint_StrategyTransport;
...
defaultproperties
{
    ...
    ActorClassesToRecord(6)=class'LWCEItemContainer'
    ...
    ActorClassesToDestroy(5)=class'LWCEItemContainer'
