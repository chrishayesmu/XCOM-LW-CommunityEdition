...
function TFinanceSection BuildCraftUI()
{
    ...
    {
        ltxtItem.strLabel = string(STORAGE().GetNumItemsAvailable(`LW_ITEM_ID(Interceptor))) $ "x" @ `LWCE_ITEM(`LW_ITEM_ID(Interceptor)).strName;
    ...
    {
        ltxtItem.strLabel = string(STORAGE().GetNumItemsAvailable(`LW_ITEM_ID(Firestorm))) $ "x" @ `LWCE_ITEM(`LW_ITEM_ID(Firestorm)).strName;
    ...
    ltxtItem.strLabel = string(STORAGE().GetNumItemsAvailable(`LW_ITEM_ID(Skyranger))) $ "x" @ `LWCE_ITEM(`LW_ITEM_ID(Skyranger)).strName;
