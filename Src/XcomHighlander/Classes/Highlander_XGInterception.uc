class Highlander_XGInterception extends XGInterception;

function CompleteEngagement()
{
    local int I;
    local Highlander_XGShip_Interceptor kInterceptor;
    ...
    else
    {
        for (I = 0; I < m_arrInterceptors.Length; I++)
        {
            kInterceptor = Highlander_XGShip_Interceptor(m_arrInterceptors[I]);
