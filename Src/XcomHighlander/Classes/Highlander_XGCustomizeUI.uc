class Highlander_XGCustomizeUI extends XGCustomizeUI
...
var array< delegate<HighlanderTypes.OnSpinnerChanged> > m_arrSpinnerHandlers;

function bool AdvanceFeature(int Feature, int Dir)
{
    local delegate<HighlanderTypes.OnSpinnerChanged> kSpinnerDelegate;
