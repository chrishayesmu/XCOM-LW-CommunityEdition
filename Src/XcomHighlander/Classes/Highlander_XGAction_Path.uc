class Highlander_XGAction_Path extends XGAction_Path;
...
simulated function UpdateShowFullTacticalGrid()
{
    ...
    if ( `HL_CHEATMGR_TAC.bDisplayMovementGrid || (kPC != none && XComTacticalInput(kPC.PlayerInput) != none && XComTacticalInput(kPC.PlayerInput).m_fRightMouseHoldTime >= 0.20) )
    {
