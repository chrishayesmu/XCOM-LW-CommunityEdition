class Highlander_XComHeadquartersInput extends XComHeadquartersInput;
...
function bool HandleClickedGlobeActor(XGStrategyActor kStrategyActor)
{
    ...
    kXGMissionControlUI = XGMissionControlUI(`HQPRES.GetMgr(class'Highlander_XGMissionControlUI', none, -1, true));
