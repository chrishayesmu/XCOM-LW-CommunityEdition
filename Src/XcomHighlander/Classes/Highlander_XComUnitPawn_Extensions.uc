class Highlander_XComUnitPawn_Extensions extends Object;
...
static simulated function ApplyShredderRocket(XComUnitPawn kUnitPawn, const DamageEvent Dmg, bool enemyOfUnitHit)
{
    ...
    local HL_TWeapon kInstigatorWeapon;
    ...
    `HL_LOG("Highlander_XComUnitPawn_Extensions: ApplyShredderRocket");
