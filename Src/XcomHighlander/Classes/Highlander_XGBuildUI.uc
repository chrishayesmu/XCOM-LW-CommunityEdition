class Highlander_XGBuildUI extends XGBuildUI;
...
function OnChooseTile()
{
    ...
    {
        HL_ConfirmRemovalDialogue(m_kCursor.X, m_kCursor.Y);
    }
}

protected function HL_ConfirmRemovalDialogue(int X, int Y)
{
    ...
    {
        if (LABS().IsInterrogationTech(`HL_LABS.HL_GetCurrentTech().iTechId))
        {
