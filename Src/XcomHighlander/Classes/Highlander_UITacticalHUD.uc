class Highlander_UITacticalHUD extends UITacticalHUD;

simulated function Init(XComTacticalController _controllerRef, UIFxsMovie _manager)
{
    BaseInit(_controllerRef, _manager);

    m_kInfoBox = Spawn(class'Highlander_UITacticalHUD_InfoPanel', self);
    ...
    m_kWeaponContainer = Spawn(class'Highlander_UITacticalHUD_WeaponContainer', self);
